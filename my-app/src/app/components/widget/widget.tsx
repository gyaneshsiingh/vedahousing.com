    ...
    return (
        <div className="vh-sticky-container">
            <div className={`vh-sticky-menu ${isOpen ? 'vh-sticky-menu-open' : ''}`}>
                ...
                <a href="sms:+919455664970" className="vh-sticky-btn vh-sms" title="Message Us">
                    <svg viewBox="0 0 24 24" fill="currentColor" height="24" width="24">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=vedahousing59@gmail.com" target="_blank" rel="noopener noreferrer" className="vh-sticky-btn vh-email" title="Email Us">
                    <svg viewBox="0 0 24 24" fill="currentColor" height="24" width="24">
